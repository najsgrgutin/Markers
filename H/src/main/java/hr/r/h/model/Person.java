...
public class Person implements Serializable {
	...
	public Person(String region, String gender, Integer yearOfBirth, String a1, String a2, String b1,
			String b2, String c1, String c2, String drb11, String drb12) {
		super();
		this.region = region;
		this.gender = gender;
	...
	public List<String> getDrb1Ms() {
		List<String> drb1Ms = new ArrayList<String>();
		drb1Ms.add(this.drb11);
		drb1Ms.add(this.drb12);
		return drb1Ms;
	}
